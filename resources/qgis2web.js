...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-7673266.102760, -3890466.730061, -7655235.695103, -3881555.028676], maxZoom: 20, minZoom: 13
    })
});
...
map.getView().fit([-7673266.102760, -3890466.730061, -7655235.695103, -3881555.028676], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        qgisAttribution.innerHTML = '<a href="https://qgis.org/">DC</a>';//Duilio Castro
